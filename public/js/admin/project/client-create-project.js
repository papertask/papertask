...
//angularApp.controller('CreateProjectController', function($scope, $http, $timeout, $q, $sce, CurrentUser, TableItemListService, ProjectType, CurrentcyRate){
angularApp.controller('CreateProjectController', function($scope, $http, $timeout, $q, $sce,  
    ...
    $scope.init = function(){
        ...
        .success(function($data){
            $scope.project.client = $data['user'];
            console.info(' $scope.project.client', $scope.project.user);
            $scope.change_client($scope.project.client);
        });
       ...
       $http.get("/api/papertask/translationtm").success(function($data){
        ...
        //$scope.project.client = CurrentUser;
   	 	//$scope.change_client($scope.project.client);
...
angularApp.controller('TableItemController', function($scope, TableItemListService, LangGroup){

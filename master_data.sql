...
VALUES ('Contract and certificate','合同和??'),('Business documents','商?文件'),('Instructions & manuals','使用?明和手?'),('Reports','?告'),('Localization','本土化'),('Comprehensive documents','?合性文件'),('Personal documents','?人文?');

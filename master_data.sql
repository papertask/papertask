...
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('1', 'Translator');
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('1', 'Proofreader');
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('2', 'Desktop Publishing');
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('3', 'Simultaneous');
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('3', 'Consecutive');
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('3', 'Business Escort');
INSERT INTO `papertask`.`Resourcep` (`group_id`, `name`) VALUES ('3', 'Tourism Escort');

...
return array(
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
        	...
        	'admin/freelancer/edit-price' => __DIR__ . '/../view/admin/freelancer/edit-price.phtml',
            'admin/freelancer/finish-registration' => __DIR__ . '/../view/admin/freelancer/finish-registration.phtml',
        		'admin/freelancer/finishRegistration' => __DIR__ . '/../view/admin/freelancer/finish-registration.phtml',
        	...
        	'admin/quote/new' => __DIR__ . '/../view/admin/quote/new.phtml',
			...
			'admin/finance/client-transaction' => __DIR__ . '/../view/admin/finance/client-transaction.phtml',

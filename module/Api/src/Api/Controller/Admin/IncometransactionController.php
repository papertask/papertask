...
use User\Entity\Intransaction;
use User\Entity\Activity;

class IncometransactionController extends AbstractRestfulJsonController
{
    /**
    ...
    public function create($data)
    {
        ...
        $intransaction->setData([
			...
			'projects' => ($data['projects'])?$data['projects']:null,
			
        ]);
		$intransaction->save($this->getEntityManager());
		//update status project to pay
		foreach($data['projectlist'] as $pr){
        ...
        return new JsonModel([
            'intransaction' => $intransaction->getData(),
            'success' => true,
        ]);
    }
